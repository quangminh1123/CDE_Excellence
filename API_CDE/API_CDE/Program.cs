...
{
    //options.JsonSerializerOptions.ReferenceHandler = ReferenceHandler.Preserve; // Giúp xử lý tham chiếu vòng lặp
    options.JsonSerializerOptions.IgnoreNullValues = true; // Bỏ qua các giá trị null
}); ;
